...
PSNRoutput=10*log10(255^2/mean((Result1(:)-IMin0(:)).^2)) 
% ========================================================
...
PSNRoutput=10*log10(255^2/mean((Result2(:)-IMin0(:)).^2)) 
% ========================================================
...
PSNRoutput=10*log10(255^2/mean((Result3(:)-IMin0(:)).^2)) 
return;
